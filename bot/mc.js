...
function createBot() {
   ...
   bot.once('spawn', () => {
      console.log('\x1b[33m[MC AFK BOT] Bot joined the server', '\x1b[0m');
      ...
      if (config.position.enabled) {
         console.log(
            `\x1b[32m[MC AFK BOT] Starting to move to target location (${pos.x}, ${pos.y}, ${pos.z})\x1b[0m`
         );
   ...
   bot.on('goal_reached', () => {
      console.log(
         `\x1b[32m[MC AFK BOT] Bot arrived at the target location. ${bot.entity.position}\x1b[0m`
      );
   });

   bot.on('death', () => {
      console.log(
         `\x1b[33m[MC AFK BOT] Bot has died and was respawned at ${bot.entity.position}`,
         '\x1b[0m'
      );
   });
   ...
   bot.on('kicked', (reason) =>
      console.log(
         '\x1b[33m',
         `[MC AFK BOT] Bot was kicked from the server. Reason: \n${reason}`,
         '\x1b[0m'
      )
   );
